import { toValue, watch, nextTick, isRef, shallowRef, ref, effectScope, onScopeDispose, computed } from 'vue';
...
function useGenericStore(key, getDefaultState, deserialize, serialize, updateStateLogic, options) {
  const debounceDelay = options?.debounceDelay ?? 300;
  const debounceMaxWait = options?.debounceMaxWait ?? 1e3;
...
export { useStoredValue as a, useGenericStore as u };
//# sourceMappingURL=useGenericStore.js.map
